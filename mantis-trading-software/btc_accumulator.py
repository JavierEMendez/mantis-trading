...
xbt_prices = universe_prices_df['XBT_USD']
features_df = calc_feature_df(xbt_prices)
...
def rebalancePortfolio(meta_level_wts, account_id, user_id):
    ...
    shrimpy_user_id = users[1]['id'] # first id in list of users
    kraken_id = 39593
    shrimpy_client.set_strategy(shrimpy_user_id, kraken_id, {
        "isDynamic":False,
        "allocations": [
...
#    initial_aum = 0 # initial assets under management
